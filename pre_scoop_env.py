...
class IsaacSim():
    def __init__(self, userDefinedSettings=None):
        # initialize gym
    ...
    def set_ball_property(self, env_ptr, ball_pose):
        ...
        ball_torsion_friction = 0
        ball_handle = self.gym.create_actor(env_ptr, self.ball_asset, ball_pose, "grain")
    ...
    def add_ball(self, env_ptr):
        ...
        ball_pose.r = gymapi.Quat(0, 0, 0, z)
    ...
    def create_franka(self):
        # create franka asset
        self.num_dofs = 0
        asset_file_franka = "franka_description/robots/franka_panda.urdf"
    ...
    def data_collection(self):
        ...
        while not self.gym.query_viewer_has_closed(self.viewer):
            ...
            if action == "up":
                ...
                dpose = torch.Tensor([[[0.],[0.],[0.],[0.],[0.],[0.]]]).to(self.device)
                print(self.franka_hand_indices)
                print(hand_pos)
                print(hand_rot)
                print()
            elif action == "quit":

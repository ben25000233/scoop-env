...
class WeighingDomainInfo(object):
    ...
    def set_parameters(self, set_info=None, type=None, reset_info=None):
        ...
        other_domains = [self.ball_friction, self.ball_layer_num, self.goal_powder_amount, self.gravity]
        if type == 'goal_condition':
            ...
            for domain in [self.ball_radius, self.ball_mass, self.ball_friction, self.ball_layer_num, self.gravity]:
                domain.set()
        else:
    ...
    def get_domain_parameters(self, type='all'):
        if type == 'all':
            ...
            target_parameters = [self.ball_radius, self.ball_mass, self.ball_friction]
    ...
    def get_domain_parameter_dim(self):
        ...
        return len([self.ball_radius, self.ball_mass, self.ball_friction])
